...
custom_replacements = {
  ...
  */
  names = {
    ...
    # IP Ranges Primary
    # Regional Address Space: 172.18.0.0/18
    primary_hub_address_space                          = "172.18.0.0/18"
    primary_hub_virtual_network_address_space          = "172.18.0.0/22"
    primary_firewall_subnet_address_prefix             = "172.18.0.0/26"
    primary_firewall_management_subnet_address_prefix  = "172.18.0.192/26"
    primary_bastion_subnet_address_prefix              = "172.18.0.64/26"
    primary_gateway_subnet_address_prefix              = "172.18.0.128/27"
    primary_private_dns_resolver_subnet_address_prefix = "172.18.0.160/28"
  }
